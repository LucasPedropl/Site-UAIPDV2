...
const PartnerLogo = ({
	...
	if (error) {
		return (
			<span
				className={`text-lg font-bold ${color} px-2 opacity-70 hover:opacity-100 transition-opacity`}
			>
				{name}
			</span>
		);
	...
	return (
		<img
			src={src}
			alt={name}
			className="h-6 sm:h-8 w-auto object-contain grayscale hover:grayscale-0 transition-all duration-300 opacity-50 hover:opacity-100 filter"
...
export const Layout: React.FC<LayoutProps> = ({
	...
	const partners = [
		{
			name: 'Stone',
			src: 'https://upload.wikimedia.org/wikipedia/commons/9/91/Stone_Pagamentos_logo.svg',
			color: 'text-gray-500',
			url: 'https://www.stone.com.br/',
		},
		{
			name: 'Bin',
			src: 'https://seeklogo.com/images/B/bin-logo-42E00F8321-seeklogo.com.png',
			color: 'text-gray-500',
			url: 'https://www.bin.com.br/',
		},
		{
			name: 'Vero',
			src: 'https://seeklogo.com/images/V/vero-logo-3058055620-seeklogo.com.png',
			color: 'text-gray-500',
			url: 'https://www.vero.com.br/',
		},
		{
			name: 'PagBank',
			src: 'https://upload.wikimedia.org/wikipedia/commons/6/66/PagBank_logo.svg',
			color: 'text-gray-500',
			url: 'https://pagseguro.uol.com.br/',
		},
		{
			name: 'Rede',
			src: 'https://upload.wikimedia.org/wikipedia/commons/2/23/Rede_logo.svg',
			color: 'text-gray-500',
			url: 'https://www.userede.com.br/',
		},
		{
			name: 'Getnet',
			src: 'https://upload.wikimedia.org/wikipedia/commons/1/14/Getnet_logo.svg',
			color: 'text-gray-500',
			url: 'https://site.getnet.com.br/',
		},
		{
			name: 'Sicredi',
			src: 'https://upload.wikimedia.org/wikipedia/commons/9/97/Sicredi-logo.svg',
			color: 'text-gray-500',
			url: 'https://www.sicredi.com.br/',
		},
		{
			name: 'Caixa',
			src: 'https://upload.wikimedia.org/wikipedia/commons/f/fa/Caixa_Econ%C3%B4mica_Federal_logo.svg',
			color: 'text-gray-500',
			url: 'https://www.caixa.gov.br/',
		},
		{
			name: 'Cielo',
			src: 'https://upload.wikimedia.org/wikipedia/commons/a/a2/Cielo_logo.svg',
			color: 'text-gray-500',
	...
	// MELHORIA: Ajustado para xl:text-base para evitar quebra em laptops (1024px)
	const getNavLinkClass = (isActive: boolean) => {
		const baseClasses =
			'font-medium transition-all duration-200 text-sm xl:text-base whitespace-nowrap';
	...
	const getDropdownTriggerClass = (isActive: boolean) => {
		// MELHORIA: Ajustado para xl:text-base e adicionado whitespace-nowrap
		const baseClasses =
			'font-medium transition-colors flex items-center gap-1 text-sm xl:text-base whitespace-nowrap';
		if (isTransparentNav) {
			return `${baseClasses} ${
				isActive
					? 'text-white font-bold border-b-2 border-white pb-1'
		...
		<div className="flex flex-col min-h-screen">
			...
			>
				<nav className="container mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
					...
					>
						<div className="bg-white w-10 h-10 sm:w-12 sm:h-12 rounded-full p-1 shadow-sm flex items-center justify-center border border-gray-200">
							<img
								src="img/logo.png"
								alt="UAI PDV"
								...
								onError={(e) => {
									e.currentTarget.src =
										'https://placehold.co/100x100?text=UAI+PDV';
					...
					{/* Desktop Nav */}
					{/* MELHORIA: Mantive hidden lg:flex, mas os itens internos agora são mais compactos em telas LG */}
					<div className="hidden lg:flex space-x-4 xl:space-x-6 items-center">
						...
						<div className="relative group">
							<button
								className={`font-medium transition-colors flex items-center gap-1 text-sm xl:text-base whitespace-nowrap ${
									!isTransparentNav
										? 'text-gray-900 hover:text-brand-blue'
										: 'text-white hover:text-gray-200'
								}`}
							...
							<div className="absolute left-0 top-full pt-3 w-60 hidden group-hover:block hover:block">
								<div className="bg-white rounded-xl shadow-xl border border-gray-100 overflow-hidden">
									...
									<div className="py-2">
										...
										<a
											href="http://webmail.uaipdv.com.br/"
											target="_blank"
											rel="noreferrer"
											className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100"
										>
					...
					{/* Mobile Menu Button */}
					{/* CORREÇÃO: Alterado de md:hidden para lg:hidden para cobrir o gap entre 768px e 1024px */}
			...
			>
				...
				>
					...
					<nav className="flex-1 overflow-y-auto px-6 py-6 space-y-6 text-base font-medium text-gray-900">
						...
						<div>
							...
							<div className="space-y-2">
								...
								<button
									onClick={() =>
										handleNavClick('segmento-distribuidora')
									}
									className={`block w-full text-left text-sm ${
										currentPage === 'segmento-distribuidora'
											? 'text-brand-blue font-medium'
											: 'text-gray-600 hover:text-brand-blue'
									}`}
								>
								...
								<button
									onClick={() =>
										handleNavClick('segmento-hortifruti')
									}
									className={`block w-full text-left text-sm ${
										currentPage === 'segmento-hortifruti'
											? 'text-brand-blue font-medium'
											: 'text-gray-600 hover:text-brand-blue'
									}`}
								>
					...
					<div className="border-t border-gray-100 px-6 py-5">
						<a
							href="#"
							className="flex items-center justify-center w-full px-4 py-3 rounded-full bg-brand-blue text-white text-sm font-semibold shadow-sm hover:bg-brand-blue-dark"
						>
							{t.navCta}
						</a>
					</div>
			...
			<footer className="bg-white border-t border-gray-200">
				...
				<div className="border-b border-gray-100 bg-gray-50/50">
					<div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
						<p className="text-center text-xs font-bold text-gray-400 uppercase tracking-[0.25em] mb-10">
							Homologado com as principais adquirentes
						</p>
