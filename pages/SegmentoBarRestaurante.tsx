                    ...
                    <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
                        ...
                        <div className="relative h-[280px] sm:h-[340px] lg:h-[400px] mx-auto max-w-lg lg:max-w-xl w-full">
                            ...
                            {digitalImages.map((img: string, idx: number) => {
                                ...
                                const isNext = idx === (currentImageIndex + 1) % digitalImages.length;
                                ...
                                return (
                                    <img
                                        ...
                                        onError={(e) => {
                                            e.currentTarget.src = 'https://placehold.co/480x720?text=App+Vendas';
                                            e.currentTarget.onerror = null;
                                        }}
                                    />
                                );
                            ...
                            <div className="absolute -bottom-10 left-1/2 -translate-x-1/2 flex gap-2 z-40">
                                {digitalImages.map((_: any, idx: number) => (
                                    <button
                                        key={idx}
